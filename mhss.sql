...
insert  into `t_calender`(`Id`,`Name`,`Date`,`Status`) values (4,'Karma','2022-08-04','Active');
...
insert  into `t_department_type`(`Id`,`Name`,`Status`) values (1,'School Management board','Active'),(2,'Dzongkha Department','Active'),(3,'English Department','Active'),(4,'Mathematics/IT department','Active'),(5,'Science Department','Active'),(6,'Commerce/Economics/Accountancy Department','Active'),(7,'Humanities & Others\' Department','Active');
...
insert  into `t_files`(`Id`,`Name`,`Type`,`image`,`Status`) values (5,'rules 2022','Rules','Khenrig Enterprise Untertaking Letter.pdf','Active');
...
insert  into `t_homeslider`(`Id`,`Name`,`Desicription`,`Status`,`Image`,`URL`) values (8,'sa','cscs','Active','chencho.jpg','bt.bt');
...
insert  into `t_post_type`(`Id`,`Name`,`Status`) values (1,'HoD','Active'),(2,'Principal','Active'),(3,'Academic head','Active'),(4,'CCD head','Active'),(5,'Chairman','Active'),(6,'Dy. chairman','Active'),(7,'Librarian ','Active'),(8,'PR','Active'),(9,'Office Assistant','Active'),(10,'Computer Lab Assistant','Active'),(11,'Biology Lab Assistant','Active'),(12,'Librarian','Active'),(13,'Store in-charge','Active'),(14,'Physics Lab Assistant','Active'),(15,'Chemistry Lab Assistant','Active'),(16,'Caretaker','Active'),(17,'Driver','Active'),(18,'Sweeper','Active'),(19,'Night Guard','Active');
...
insert  into `t_staff`(`Id`,`Name`,`Year`,`Department`,`Qualification`,`Email`,`Phone`,`Post`,`Serving_tenure`,`Status`,`image`) values (1,'sonam','1992','School Management Board','MBBS','sdorji815@gmail.com','0097517458669','English Department','wsdwdw','Active','uploads/Staff/WhatsApp Image 2022-08-03 at 12.17.57 PM.jpeg'),(2,'PSYCHIATRIC/BEHAVIORAL PROBLEMS/SUICIDE','1992','Commerce/Economics/Accountancy Department','MBBS','admin','0097517458669','English Department','wsdwdw','Active','uploads/Staff/WhatsApp Image 2022-08-03 at 12.17.57 PM.jpeg');
...
insert  into `t_user`(`Id`,`Email_Id`,`Password`,`Mobile_Number`,`Name`,`Status`,`Image`,`Created_date`) values (1,'sdorji815@gmail.com','$2y$10$oVQ6BavZ3QGabxRjyvKxduBq4lJFSQwAR6cPfGzLb9F6CDFP38iay','772298','SONAM DORJI','Active','Half Photo.jpg','2021-05-07 14:34:29');
