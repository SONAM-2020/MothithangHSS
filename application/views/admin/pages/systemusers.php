        ...
        <div class="box-body">
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tr>
              ...
              <td>
                <button type="button" class="btn btn-block btn-primary" onclick="editinfo('<?php echo $event['Id']?>','<?php echo $event['Email']?>','<?php echo $event['Name']?>','<?php echo $event['Designation']?>','<?php echo $event['Contact_No']?>','<?php echo $event['Role_Id']?>','<?php echo $event['Status']?>')"><i class="fa fa-edit"></i>Edit</button> 
              </td>
              </tr>
              <?php endforeach;?>
            </tbody>
...
function addusersinfo(){
  ...
  function validateaddform(){
   ...
   function editinfo(Editid,email,name,designation,phone,rol,tatus){
      $('#EditId').val(Editid);
      $('#Name1').val(name);
      $('#Email1').val(email);
