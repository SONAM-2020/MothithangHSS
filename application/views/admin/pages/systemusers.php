...
<section class="content">
   <div class="callout callout-info">
        <h4>Reminder!</h4>
       System will automatically create password for all the User that you create.The system created password (mhss@2022)
      </div>
      <?php  
...
function addusersinfo(){
  ...
  function validateaddform(){
   ...
   function editinfo(Editid,email,name,phone,tatus){
      $('#EditId').val(Editid);
      $('#Name1').val(name);
      $('#Email1').val(email);
      $('#Phone1').val(phone);
