  ...
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Create New Offers</h3>
        ...
        <div class="box-body">
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
            <?php foreach($t_offers as $i=> $event): ?>
            <tr>
              <td><?=$i+1?></td>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                          ...
                          <select id="type" onclick="remove_err('type_err')" class="form-control" name="type">
                            <option value="">-----</option>
                            <option value="BT Offer">BT Offer</option>
...
<script type="text/javascript">
 ...
 function addinfo(){
    $('#actiontype').val('add');
    $('#medelheaderspan').html('Add Offers');
    $('#btnspan').html('<i class="fa fa-save"></i> Add  Offers');
...
function addproductinfo(){
  ...
  $.blockUI
      ...
      var url='<?php echo base_url();?>index.php?adminController/AddOffers';
