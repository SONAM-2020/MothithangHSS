        ...
        <div class="box-body">
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tr>
              ...
              <td><img style="width: 100px; height: 100px;" src="<?php echo base_url();?>uploads/slider/<?php echo$event['Image'];?>"></td>
              <td>
...
function addsliderinfo(){
  ...
  function validateaddform(){
    ...
    var url='<?php echo base_url();?>index.php?adminController/loadpage/Viewsliderinformation/'+id;
