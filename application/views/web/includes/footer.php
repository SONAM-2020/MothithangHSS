<footer class="footer">
        <div class="f_logo">
            ...
            <p class="phone">Phone No: +975 12345/123434</p>
            <p>Email:<a href="mailto:motithang@edu.BT" class="f_link">motithang@gov.edu.bt</a></p>
        ...
        <div class="quickLinks">
            ...
            <p>
                ...
                <a href="" class="f_link">Royal University of Bhutan</a> 
                
            </p>
            <p>
                
                <a href="" class="f_link">Ministry of Labour and Human Resources</a> 
                
            </p>
            <p>
                
                <a href="" class="f_link">Royal Civil Service Commission</a> 
                
            </p>
            <p>
                <a href="" class="f_link"> Ministry of Education </a>
                
            </p>
            <p>
                <a href="" class="f_link">G2C Services</a>
                
            </p>
            <p>
                <a href="" class="f_link">Ministry of Information and Communication</a>
                

            </p>
            <p>
                <a href="" class="f_link">Department of Information Technology and Telecom</a>
        ...
        <div class="quickLinks">
            ...
            <p>
                <a href="" class="f_link">Staff Profiles</a>
                
            </p>
            <p>
                <a href="" class="f_link"> Academic Calender</a>
                
            </p>
            <p>
                <a href="" class="f_link">Events</a>
                
            </p>
            <p>
                <a href="" class="f_link">Announcements</a>
                
            </p>
            <p>
                <a href="" class="f_link">Mission and Vision</a>
        ...
        <div class="quickLinks"> 
            ...
            <p>
                <a href="" class="f_link">Result</a> 
            </p>
            <p>
               <a href="" class="f_link">Past Papers</a> 
            </p>
        </div>
        ...
        <div class="quickLinks">
            ...
            <p>
                <a href="" class="f_link"> About Us</a>
            </p>
            <p class="icons">
                <span>
    ...
    <div class="line">
        ...
        <p class="copyright">
            copyright @copyright    motithang higher secondary school 2022, all rights reserved
        </p>
    </div>

<script src = "<?php echo base_url();?>assest/website/NavPage/nav.js"></script>
