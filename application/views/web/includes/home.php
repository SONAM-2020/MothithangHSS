                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6">
                            <div class="service-bx">
                                ...
                                <div class="info-bx text-center">
                                    ...
                                    <p style="text-align: center;"><?=$t_aboutus->Mission;?></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-6">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <div class="service-bx m-b0">
                                ...
                                <div class="info-bx text-center">
                                    ...
                                    <p style="text-align: center;"><?=$t_aboutus->Motto;?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 heading-bx left">
                            <h2 class="title-head">Motithang <span>Staff</span></h2>
                        </div>
                    </div>
                    <div class="row">
                    <div class="courses-carousel owl-carousel owl-btn-1 col-12 p-lr0">
                        ...
                        <div class="item">
                            <div class="cours-bx">
                                <div class="action-box">
                                    <img src="<?php echo base_url();?><?php echo$event['image'];?>" alt="">
                                </div>
                                <div class="info-bx text-center">
                                    <h5><a href="#"><?php echo$event['Name'];?></a></h5>
                                    <span><?php echo$event['Department'];?></span>
                                    <p><a href="#"><?php echo$event['Email'];?></a></p>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 text-center text-white">
                            <h2>མུ་ཏིག་ཐང་འབྲིང་རིམ་སློབ་གྲྭ་གོང་མ</h2>
                            <h5>Motithang Higher Secondary School</h5>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-6">
                                <div class="cours-search-bx m-b30">
                                    <div class="icon-box">
                                        <h3><i class="ti-user"></i><span class="counter">5</span></h3>
                                    </div>
                                    <span class="cours-search-text">Number of Student</span>
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-6">
                                <div class="cours-search-bx m-b30">
                                    ...
                                    <span class="cours-search-text">Number of Staff</span>
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-12">
                                <div class="cours-search-bx m-b30">
                                    <div class="icon-box">
                                        <h3><i class="ti-layout-list-post"></i><span class="counter">1975</span></h3>
                                    </div>
                                    <span class="cours-search-text">Established Date</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="section-area section-sp2">
                <div class="container">
                    ...
                    <div class="upcoming-event-carousel owl-carousel owl-btn-center-lr owl-btn-1 col-12 p-lr0  m-b30">
                        <?php foreach($t_events as $i=> $event): ?>
                        <div class="item">
                            <div class="event-bx">
                                <div class="action-box">
                                    <img src="<?php echo base_url();?><?php echo$event['Image'];?>" alt="">
                                ...
                                <div class="info-bx d-flex">
                                    <div>
                                        <div class="event-time">
                                           <!--  <div class="event-date"><?php echo$event['Type'];?></div> -->
                                            <div class="event-month"><?php echo$event['Date'];?></div>
                                        </div>
                                    </div>
                                    <div class="event-info">
                                        <h4 class="event-title"><a href="#"><?php echo$event['Name'];?></a></h4>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 heading-bx left">
                            ...
                            <p>Update of Motithang Higher Secondary School</p>
                        </div>
                    </div>
                    <div class="recent-news-carousel owl-carousel owl-btn-1 col-12 p-lr0">
                        ...
                        <div class="item">
                            <div class="recent-news">
                                ...
                                <div class="info-bx">
                                    <ul class="media-post">
                                        <li><a href="#"><i class="fa fa-calendar"></i><?php echo$event['Date'];?></a></li>
                                    </ul>
                                    <h5 class="post-title"><a href="#"><?php echo$event['Name'];?></a></h5>
